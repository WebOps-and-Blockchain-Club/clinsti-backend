...
router.get('/client/complaints/:complaintid', auth, async (req, res) => {
    ...
    try {
        ...
        const {complaint_id, description, _location, waste_type, zone, status, created_time, registered_time, work_started_time, completed_time, images, feedback_rating, feedback_remark, admin_remark} = result.rows[0];
        return res.status(200).send({complaint_id, description, _location, waste_type, zone, status, created_time, registered_time, work_started_time, completed_time, images, feedback_rating, feedback_remark, admin_remark})
